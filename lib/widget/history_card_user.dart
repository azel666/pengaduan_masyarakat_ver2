...
import 'package:pengaduan_masyarakat_ver2/view/user_view/history_detail.dart';

class HistoryCardUser extends StatelessWidget {
  final listAllDocs;
  const HistoryCardUser({this.listAllDocs, super.key});
          ...
          children: [
            InkWell(
              onTap: () {
                ...
                Get.to(HistoryDetail(detail: detail));
              },
              child: Container(
